  ...
  export default{
    ...
    methods : {
      changePage(page) {
        ...
        this.$emit('paginate');
        if(this.pagination.current_page > 1){ this.back = '' } else { this.back = 'disabled' }
        if(this.pagination.current_page < this.pagination.last_page ){ this.next = '' } else { this.next = 'disabled' }
      }
    }
  }
</script>